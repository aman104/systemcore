...
/**
 * MailingLink filter form base class.
 *
 * @package    SystemCore
 * @subpackage filter
 ...
 */
abstract class BaseMailingLinkFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'click'      => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('mailing_link_filters[%s]');
