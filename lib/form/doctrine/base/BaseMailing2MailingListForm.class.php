...
/**
 * Mailing2MailingList form base class.
 *
 * @method Mailing2MailingList getObject() Returns the current form's model object
 *
 * @package    SystemCore
 * @subpackage form
 ...
 */
abstract class BaseMailing2MailingListForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mailing2_mailing_list[%s]');
